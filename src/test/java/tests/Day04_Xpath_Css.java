...
//        location username and typing username
...
//        locating submit button and click
     ...
     * -I also sometimes create dynamic xpath. Because some elements do not have stable attributes like id
     *  and name. And I can write xpath for any element.
     ...
     * --css is a little faster than xpath(way less than 1 second). xpath does navigation in the html that
     *  takes a little bit time
     * --there are more ways to write xpath. For example, dynamic xpath has contains, starts-with,
     *  ends-with functions
     *
     * */
