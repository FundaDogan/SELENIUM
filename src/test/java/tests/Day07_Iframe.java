...
//        Verify the Bolded text contains “Editor”
        ...
        // Locate the text box
        //note : text box is in the iframe, so we need to switch
